        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimalSpeciesLifeSpan = table.Column<int>(type: "int", nullable: false),
                    AnimalSpeciesPurchasePrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_AnimalSpecies_AnimalSpeciesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarnLocation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BarnPersonInCharge = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BarnMaxCapacity = table.Column<int>(type: "int", nullable: false),
                    BarnCapacity = table.Column<int>(type: "int", nullable: false),
                    BarnBalance = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Barns_AspNetUsers_OwnerUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnimalGender = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animals_AnimalSpecies_AnimalSpeciesId",
                        column: x => x.AnimalSpeciesId,
                        principalTable: "AnimalSpecies",
                        principalColumn: "AnimalSpeciesId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BarnInventoryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BarnId = table.Column<int>(type: "int", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BarnInventories", x => x.BarnInventoryId);
                    table.ForeignKey(
                        name: "FK_BarnInventories_Barns_BarnId",
                        column: x => x.BarnId,
                        principalTable: "Barns",
                        principalColumn: "BarnId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BarnInventories_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Purchases_AnimalSpecies_AnimalSpeciesId",
                        column: x => x.AnimalSpeciesId,
                        principalTable: "AnimalSpecies",
                        principalColumn: "AnimalSpeciesId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Purchases_Barns_BarnId",
                        column: x => x.BarnId,
                        principalTable: "Barns",
                        principalColumn: "BarnId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    SoldByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sales", x => x.SaleId);
                    table.ForeignKey(
                        name: "FK_Sales_Barns_BarnId",
                        column: x => x.BarnId,
                        principalTable: "Barns",
                        principalColumn: "BarnId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BarnInventories_ProductId",
                table: "BarnInventories",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Barns_OwnerUserId",
                table: "Barns",
                column: "OwnerUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Products_AnimalSpeciesId",
                table: "Products",
                column: "AnimalSpeciesId");

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_AnimalSpeciesId",
                table: "Purchases",
                column: "AnimalSpeciesId");

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_BarnId",
                table: "Purchases",
                column: "BarnId");

            migrationBuilder.CreateIndex(
                name: "IX_Sales_BarnId",
                table: "Sales",
                column: "BarnId");
